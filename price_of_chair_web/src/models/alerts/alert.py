...
class Alert(object):
    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "text": "We've found a deal!  ({}).  To navigate to the alert, visit {}".format(self.item.url, "http://pricing.jslvtr.com/alerts/{}".format(self._id))
            }
        )
    ...
    def delete(self):
        return Database.remove(AlertConstants.COLLECTION, {'_id': self._id})
